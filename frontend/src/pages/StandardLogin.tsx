  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-zinc-50 to-zinc-100 px-4 py-12 dark:from-zinc-950 dark:to-zinc-900">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 blur-3xl dark:from-violet-500/10 dark:to-fuchsia-500/10" />
        <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-gradient-to-br from-amber-500/20 to-rose-500/20 blur-3xl dark:from-amber-500/10 dark:to-rose-500/10" />
      </div>
      ...
      >
        <a
          href="#main-content"
          className="block bg-zinc-900 p-2 text-center text-white dark:bg-zinc-50 dark:text-zinc-900"
        >
      ...
      >
        <div className="rounded-2xl border border-zinc-200/50 bg-white/80 p-8 shadow-2xl backdrop-blur-xl dark:border-zinc-800/50 dark:bg-zinc-950/80">
          <div className="mb-8 text-center">
            <h1 className="mb-2 text-3xl font-bold" id="main-content">
              Sign In
            </h1>
            <p className="text-zinc-500 dark:text-zinc-400">
              Welcome back to InclusiveCart
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <label className="flex cursor-pointer items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400">
                  <input
                    ...
                    className="h-4 w-4 rounded border-zinc-300 text-zinc-900 focus:ring-zinc-400 dark:border-zinc-700 dark:bg-zinc-800"
                  />
                  Show password
                </label>
                <label className="flex cursor-pointer items-center gap-2 text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              type="button"
              disabled
              className="flex cursor-not-allowed items-center justify-center gap-3 rounded-xl border border-zinc-200 bg-white px-4 py-3 text-sm font-medium text-zinc-400 transition-all dark:border-zinc-800 dark:bg-zinc-900"
