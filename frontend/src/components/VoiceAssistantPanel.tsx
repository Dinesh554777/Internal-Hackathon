  ...
  return (
    <motion.div
      ...
      className={`fixed bottom-6 right-6 z-50 flex flex-col rounded-2xl border border-zinc-200/50 bg-white shadow-2xl dark:border-zinc-800/50 dark:bg-zinc-900 ${
        areLargeButtons ? 'w-[420px]' : 'w-[380px]'
      } max-h-[600px]`}
      role="dialog"
    ...
    >
          ...
          <div className="flex flex-col items-center justify-center py-6">
            ...
            {state === 'speaking' && (
              <div className="w-full text-center">
                <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-950">
      ...
      {pendingConfirmation && (
        <div className="mx-4 mb-2 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-950/50">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center justify-center rounded-xl text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-zinc-800 ${
                areLargeButtons ? 'h-12 w-12' : 'h-10 w-10'
              }`}
              aria-label="Settings"
            >
              <Settings className={areLargeButtons ? 'h-5 w-5' : 'h-4 w-4'} />
            </button>
          </div>
        </div>
